...
type sortByType = 'nama' | 'fullCode' | 'code' | 'created_at'
...
export default function CategoryIndex() {
    ...
    useEffect(() => {
        const newUrl = `${baseUrl}/api/provinces?search=${searchTerm}&sortBy=${sortBy}&sortDir=${sortDir}`;
        setUrl(newUrl);
        setReload(true)
    ...
    const { isLoading, error, result } = useApi<PaginationResponse<Province>>({
        url: url,
        headers: {
    ...
    return (
        <div className="container mx-auto py-4">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent className="w-56">
                                ...
                                <DropdownMenuRadioGroup value={sortBy} onValueChange={value => {
                                    ...
                                    <DropdownMenuRadioItem value="fullCode">Kode lengkap</DropdownMenuRadioItem>
                                    <DropdownMenuRadioItem value="code">Kode</DropdownMenuRadioItem>
            ...
            {!error && !isLoading && result && <DataTable columns={ProvinceColumn} data={result.data} />}
